          ...
          <ul className="flex items-center gap-4">
            <li>
              <a href={`https://discord.com/users/${user.discord_user.id}`} target="_blank" rel="noreferrer">
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-8"
                     fill="#5865F2">
                  <path
            ...
            <li>
              <a href="https://x.com/YuutoGoat" target="_blank" rel="noreferrer">
                <svg role="img" className="size-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <div className="space-y-0.5 overflow-hidden text-gray-100">
                <p className="truncate">
                  ...
                  {activity.type === 2 ? activity.sync_id ? <a
                    ...
                    className="text-blue-500 duration-150 hover:text-blue-400" title={activity.details}
                  >
                    {activity.details}
                ...
                {activity.assets && activity.assets.large_text && activity.type === 2 ? (
                  <p className="text-sm">On&nbsp;{activity.assets.large_text}</p>
                ) : (
